...
const registerSchema = z.object({
    ...
    password:z.string().trim().toLowerCase().min(8,"Password Must Be At least 8 caracters"),
    role:z.string().trim().toLowerCase().min(3).enum(["admin", "dev", "finance", "sales", "support"]),
